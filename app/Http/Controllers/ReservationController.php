...
class ReservationController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $checkin=$request->input('checkin');
        $checkout=$request->input('checkout');
        $allocations=Roomallocation::where('category_id', $category_id)
        ->whereNotBetween('checkin', [$checkin, $checkout])
        ->whereNotBetween('checkout', [$checkin, $checkout] )
        ->limit($nor)->get();
    ...
    Roomallocation::where('room_id', $allocation->room_id)
            ...
            return view('reservations.checkout')->with([
...
public function destroy(Reservation $allocation){
    ...
    $allocation->delete();
    return to_route ('rervations.index')->with('success','Room reservation Has Been deleted Successfully');
